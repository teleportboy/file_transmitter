...
class Packet : public QObject {
    Q_OBJECT
public:
    Packet(QByteArray data, QString address, int id = 0, PacketType type = PacketType::SendFilePacket,
           quint16 port = 2417, int msDelayResent = 500, QObject* parent = nullptr);
